...
class _SidePanelState extends State<SidePanel> {
  ...
  void _openWebService(String title, String url) {
    ...
    Navigator.of(
      context,
    ).push(_createSlideUpRoute(WebViewScreen(url: url, title: title)));
  }
    ...
    showDialog(
      ...
      builder: (context) {
        ...
        return FrostedAlertDialog(
          ...
          title: Text(
            t.translate('settings_select_language'),
                    ...
                    children: [
                      _buildMenuItem(
                        ...
                        onTap: () {
                          ...
                          Navigator.of(
                            context,
                          ).push(_createSlideUpRoute(AccountCenterPage()));
                        },
                      ),
                      _buildMenuItem(
                          ...
                          child: ExpansionTile(
                            ...
                            children: [
                              ListTile(
                                ...
                                title: Text(
                                  t.translate('service_spirit'),
                                  style: TextStyle(fontSize: 14),
                                ),
                                onTap: () => _openWebService(
                                  "SPIRIT ACADEMIA",
                                  "https://academia.pnj.ac.id/",
                                ),
                                dense: true,
                              ),
                              ListTile(
                                ...
                                title: Text(
                                  t.translate('service_elearning'),
                                  style: TextStyle(fontSize: 14),
                                ),
                                onTap: () => _openWebService(
                                  "E-Learning PNJ",
                                  "https://elearning.pnj.ac.id/",
                                ),
                                dense: true,
                              ),
                              ListTile(
                                ...
                                title: Text(
                                  t.translate('service_academic'),
                                  style: TextStyle(fontSize: 14),
                                ),
                                onTap: () => _openWebService(
                                  "Akademik PNJ",
                                  "https://akademik.pnj.ac.id/",
                                ),
                                dense: true,
                              ),
                              ListTile(
                      ...
                      _buildMenuItem(
                        ...
                        onTap: () {
                          ...
                          Navigator.of(
                            context,
                          ).push(_createSlideUpRoute(SavedPostsScreen()));
                        },
                      ),
                      _buildMenuItem(
                        ...
                        onTap: () {
                          ...
                          Navigator.of(
                            context,
                          ).push(_createSlideUpRoute(SettingsPage()));
                        },
                      ),
                    ],
                  ),
