...
class PostHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final timeAgo = _formatTimestamp(
      postData['created_at'] ?? postData['timestamp'],
    );
  ...
  Widget _buildAvatar(BuildContext context) {
    ...
    final String? profileImageUrl =
        ...
        postData['avatarUrl'];
    final int iconId =
        postData['avatar_icon_id'] ?? postData['avatarIconId'] ?? 0;
  ...
  Widget _buildHeaderContent(
    ...
    if (communityId != null && isCommunityPost) {
      ...
      final String userName =
          postData['user_name'] ?? postData['userName'] ?? 'Member';
    ...
    if (communityId != null && !isCommunityPost) {
      final String userName =
          postData['user_name'] ?? postData['userName'] ?? 'User';
      final String comName =
          postData['community_name'] ??
          postData['communityName'] ??
          'Community';
    ...
    final String userName =
        postData['user_name'] ?? postData['userName'] ?? 'User';
    final String email =
        postData['user_email'] ?? postData['userEmail'] ?? 'user';
            ...
            PopupMenuItem(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    isPrivate
                        ? t.translate('menu_unhide')
                        : t.translate('menu_hide'),
                  ),
                ],
              ),
            ),
            PopupMenuItem(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    isPinned
                        ? t.translate('menu_unpin')
                        : t.translate('menu_pin'),
                  ),
                ],
              ),
            ),
            ...
            PopupMenuItem(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 12),
                  Text(t.translate('menu_edit_admin')),
                ],
              ),
            ),
            PopupMenuItem(
            ...
            PopupMenuItem(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 12),
                  Text(t.translate('menu_report_comm')),
                ],
              ),
            ),
          );
