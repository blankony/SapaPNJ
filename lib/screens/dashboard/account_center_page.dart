...
class _AccountCenterPageState extends State<AccountCenterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        Scaffold(
          appBar: FrostedAppBar(title: Text(t.translate('settings_account'))),
          body: ListView(
            children: [
              Padding(
              ...
              ListTile(
                ...
                subtitle: Text(
                  isEmailVerified
                      ? t.translate('account_verified')
                      : t.translate('account_action_req'),
                ),
              ...
              (() {
                ...
                return ListTile(
                  ...
                  subtitle: Text(
                    isGoogleBound ? 'Linked to Google' : 'Not linked to Google',
                  ),
              ...
              if (isEmailVerified)
                (() {
                  ...
                  final String status =
                      _userDbData['verification_status'] ??
                      _userDbData['verificationStatus'] ??
                      'none';
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.of(context)
                      .push(_createSlideRightRoute(EditProfileScreen()))
                      .then((_) => _refreshUser());
                },
              ),
              ...
              _PrivacySwitchTile(
                isPrivate:
                    _userDbData['is_private'] == 1 ||
                    _userDbData['is_private'] == true,
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.of(
                    context,
                  ).push(_createSlideRightRoute(ChangePasswordScreen()));
                },
              ),
              ...
              ListTile(
                ...
                title: Text(
                  t.translate('account_delete_title'),
                  style: TextStyle(color: Colors.red),
                ),
  ...
  Future<void> _togglePrivacy(
    ...
    final bool? confirm = await showDialog<bool>(
      ...
      builder: (ctx) => FrostedAlertDialog(
        title: Text(
          isCurrentlyPrivate
              ? t.translate('account_switch_public')
              : t.translate('account_switch_private'),
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
        ...
        try {
          ...
          if (context.mounted) {
            OverlayService().showTopNotification(
              context,
              !isCurrentlyPrivate
                  ? t.translate('account_privacy_now_private')
                  : t.translate('account_privacy_now_public'),
          ...
          if (context.mounted) {
            OverlayService().showTopNotification(
              context,
              t.translate('account_privacy_update_fail'),
              Icons.error,
              () {},
              color: Colors.red,
            );
  ...
  Widget build(BuildContext context) {
    ...
    return SwitchListTile(
      ...
      onChanged: _isUpdating
          ? null
          : (_) => _togglePrivacy(context, widget.isPrivate),
    );
  }
}
