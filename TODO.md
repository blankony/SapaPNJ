...
## Bugs
- [ ] Replies on the blogpost page constantly refresh during typing instead of just refreshing after sending a message or manual refresh
- [ ] On the profile page the replies is not showing anything at all.
